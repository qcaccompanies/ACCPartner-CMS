...
WebUI.navigateToUrl('http://accseamless.stage.digitalintegrasiasia.com/login')
...
if (expected == 'pass') {
    ...
    switch (status.toString()) {
        ...
        case 'wrong username or password':
            WebUI.verifyElementPresent(findTestObject('admin login/div_USER NAME ATAU PASSWORD SALAH'), 0)
